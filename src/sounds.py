    ...
    def __init__(self):
        ...
        try:
            ...
            self.sounds = {
                ...
                "collect": self._make_chime([(760, 0.05, 0.2), (980, 0.07, 0.16)]),
                "checkpoint": self._make_chime([(520, 0.06, 0.16), (700, 0.08, 0.18)]),
                ...
                "correct": self._make_chime([(740, 0.05, 0.16), (960, 0.08, 0.18)]),
